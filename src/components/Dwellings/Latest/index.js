...
class Latest extends Component {
    ...
    componentDidMount() {
        this.props.requestLoadMoreDwellings(this.state.page);
    }
                        ...
                        {this.state.items.map(dwelling => (
                            <Col sm="6" md="4" key={dwelling._id}>
                                ...
                                >
                                    ...
                                    <img src={dwelling.images[0] !== undefined ? dwelling.images[0].secure_url : 'http://via.placeholder.com/330x220'}/>
...
export default connect(
    ...
    dispatch => ({
        requestLoadMoreDwellings: page => dispatch(requestLoadMoreDwellings(page))
    })
)(Latest);
